...
class msMementoOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('msmemento_item_err_ns');
        }
...
return 'msMementoOfficeItemUpdateProcessor';
